...
>
    <div class="overflow-x-clip">
        <header
            class="fi-sidebar-header flex gap-8 h-16 items-center bg-white px-6 ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 lg:shadow-sm"
        >
            <div
            ...
            <div>
                <a class="px-4" href="{{ url(LaravelLocalization::getCurrentLocale().'/home') }}">{{ __('Web site') }}</a>
            </div>
