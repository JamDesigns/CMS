                ...
                <div class="mx-auto max-w-screen-lg px-4 md:px-8">
                    <div class="grid gap-8 sm:grid-cols-2">
                        <div class="flex flex-col items-center justify-center sm:items-start md:py-24 lg:py-32">
                            <h1 class="text-4xl font-bold text-red-500 mb-5">@yield('code') - @yield('title')</h1>
                            <p class="text-gray-txt mb-5">@yield('message')</p>
                        ...
                        <div class="relative h-80 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-auto">
                            <svg class="text-blue-600" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
