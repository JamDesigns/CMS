    ...
    'call_to_action_buttons' => [
        'options' => [
            'primary' => [
                ...
                'class' => 'px-4 py-2 text-sx text-indigo-700 border border-transparent rounded-md font-semibold hover:text-white hover:bg-indigo-800',
            ],
            'primary_chevron' => [
                ...
                'class' => 'px-4 py-2 font-semibold text-xs hover:text-indigo-800',
            ],
            'secondary' => [
                ...
                'class' => 'px-4 py-2 bg-gray-700 border border-transparent rounded-md font-semibold text-xs text-gray-100 uppercase hover:bg-indigo-800 focus:bg-indigo-800',
            ],
            'secondary_chevron' => [
                ...
                'class' => 'px-4 py-2 font-semibold text-xs hover:text-gray-700',
            ],
            'ghost' => [
